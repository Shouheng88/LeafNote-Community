...
## 5.3.2 
 - 954b9ec3 解决一个空指针问题
- 5643ab33 easymark模块改为依赖形式
- 19d56bfb easymark模块改为依赖形式
- e001f24a UI模块改为依赖形式
## 5.3.1 
 - 065b88d9 移除无用的依赖，解决审核问题
## 5.3.0 
 - 56a13778 问题处理页面一直加载的问题
- 1a51e793 菜单选项根据是否展示会员而调整
- 86d90158 优化提升
- 97b728e0 导出图片权限细化
- eb156b5a 导出图片toast不显示的问题
- 6ac7dbee 获取存储路径失败的问题
- a0f1abd6 样式优化
- 4707550a 样式优化
- 5b50b77b 样式优化
- 4caa19e7 会员信息页面布局
- 97477b45 首页底部菜单单行数量调整
- 2397b31a 首页会员信息
- 210409ee 首页会员信息
- 64781257 文案
- 7181a253 文案
- a3c8edd4 用户信息变化时，首页会员信息更新
- ae429937 文案
- f557b113 文案
- 56fa354d 文案
- ba110147 密钥导出状态提示
...
- 978083f0 增加助记词输入逻辑
- c1b6b49c 增加助记词输入逻辑
- 66416a28 通知栏快捷入口改为新的快捷笔记对话框
- 09774918 会员页面产品布局适配平板
- 51eada45 设置页面文案修复
- 343e9ac7 快速笔记的存储目录
- b1d75a20 搜索结果和数据统计的显示冲突
- 9a369089 文案
- e2ad7409 图片问题修复
- a8a912c2 多和少点提示
- bdc54bb1 多和少点提示
...
- 0759bfc8 笔记快速保存
- c2799e40 笔记快速保存
- bb6d0c95 移动帮助和反馈页面入口
- c257dfbf 添加引导相关的逻辑（暂时，未启用）
- 23a841ed 加个彩蛋
- 87ec241d 会员页面登录入口改版
- e1b35038 会员页面登录提示
- 5feac571 文案
- 72945d4a 文案
- 1d73dca4 文案
- 95aa5be2 付款流程对话框样式优化
- 12a10b7f 计算方式切换
- b4d5ea66 用户评论缓存增加过期时间
- fedb32ca 会员权益布局调整
- 9160a174 会员权益文案
- 5d7c7bf8 会员页面样式
- 4389b9fe 会员页面样式
...
- f5aef001 首页消息显示
- f1fb97ee 笔记同步支持严格模式
- 8d611cef 增加图片的导出和分享逻辑
- 2c987c99 文案
- 384d95b1 增加图片导出功能
- 52a48fa7 调整导出图片应用信息的尺寸
- caef0659 算了，不改了
- ebb75444 文案
- 3e913a0b 内部目录增加过滤
- c7dad8d0 回顾页面空态
...
- 2f99df49 记录页面浏览信息
- 488d5e1c db
- c9594df0 增加记录笔记浏览信息的方法
- eea91817 解析笔记的时候记录字符数量
- 080b39d0 添加笔记浏览记录资源
- 475e60ba 口号调整
- c5ea984e 增加导出的品牌信息
- 76cba9aa 同步设置对话框提示
...
- dd15f9d0 空 提示
- 58e29f57 空 提示
- 1cb4bc20 会员对话框增加免费试用提示
- 17306e7a 登录页面调整
- 96dbf9a5 增加高度限制和滚动效果
- 8b9ec58e 文案
- 790479f3 目录使用的消息对话框
- c34356e8 对话框调整
- 7adc5abb 对话框调整
...
- f18a83fc 笔记链接展示
- a329fbfe 文案
- 6c90b105 打印PDF菜单位置调整
- ce756bc8 标签编辑对话框逻辑调整
- a5e4865a 前置信息逻辑重构，写入笔记的时候再次检查和处理前置信息
- 22f9f130 code
- 19462f7e code
- f50aa991 code
- 842c9711 笔记浏览页面设置调整
...
- 8434af7c 完成笔记截图的逻辑
- f36eb14f 修复截图缩放计算问题
- 0fd99dd0 开放源代码并且增加文档说明
- 87a480b3 打印的时候CSS代码折叠
- 5fe0c124 打印的时候CSS代码折叠
- e60906c9 分享图片逻辑的实现
- 3f310aa6 移除无用资源
- c7f10889 打印PDF
- 14be58b2 获取html对话框样式
- af22abfd 体验优化
- f8d8d4c1 添加文件分享逻辑
- 1aa7e9af HTML分享逻辑
- cccc73a6 添加分享UI逻辑
- d424f028 笔记菜单逻辑添加
- 523af494 添加新的笔记设置对话框
- 0bc96dee 移除无用资源
- 13782a13 编辑器主题会员标识
- e72c4886 图片重命名逻辑优化
- d29f8f78 目录和图片的菜单对话框调整
- 6065ab4d 图片菜单调整
- bdb9d603 设置对话框列表样式
- 5b5b7620 设置对话框列表样式
- e9df0d63 目录设置对话框样式调整
- 9ca84954 批处理页面增加图片操作
- 15b8d17b 批处理页面增加图片操作
- 3e048077 批量处理页面UI优化
- f4d91c47 文案优化
- 3b2eb69a 文案优化
- 04804426 搜索设置对话框优化
...
- 8c525892 搜索结果优化
- b53069ea 搜索代码优化
- 75d95ba5 搜索页面和笔记列表空态优化
- 7c4ae154 移除垃圾设计
- 933e5e11 目录展示逻辑统一调整
- 9e667368 隐藏目录相关逻辑梳理
- 411547ca 首页顶部图片目录列表显示图片
- 95aa084c 图片存储提示优化
- 8ee7ee46 flomo导入提示优化
- 9976e69d 目录创建文案优化
- c351d403 文案
- ae0eac8b 加密逻辑增加版本2
- 4825155c 文案
...
- 3d8bfeba 设置首页分组
- 07597555 外观设置样式调整
- 89a85156 文案调整，回顾引导移动到页面内部
- e3cf3c05 首页抽屉样式调整完成
- 1939ce12 首页抽屉样式调整
- 35433a92 创建子目录逻辑移动到顶部对话框
- 4f3fba12 添加新的对话框样式
- 28f152df 添加多语言
- 501d3984 文案
- eaa45cd2 首页确定笔记录入按钮样式调整
- ba8bf94c ui调整
- 21c257c8 笔记快捷输入按钮样式调整
- d68572f8 首页底部菜单样式调整
- e99f1214 笔记列表样式调整
- 6d104ca2 主题色调整
- 88cc5896 示例文章问题修复
- c1375527 示例文章创建
- e841ba2d 隐藏笔记列表样式引导
- 8c3e34d7 应用内页面的顶部工具栏状态适配
- a55ea54e 添加arch-android源码依赖
- af8f1e7c 添加arch-android源码依赖
- b64ff16b 首页顶部菜单位置
- a71e3063 适配返回事件
- 7faadebe 升级目标版本为36
## 5.3.0 
 - 40b78935 修复应用宝的傻逼审核问题：点击关于板块的多个板块点击后直接跳转至内嵌网页，属于空壳应用，请修改为移动端原生内容或移除该板块后重新提交。
## 5.3.0 
 - 8d770206 修复问题：APP隐私政策弹窗点击不同意退出之后，重新打开没有了隐私弹窗可以进去应用，需要改为必须点击同意按钮后才可进入APP，请修改后重新提交。
## 5.3.0 
 - 7d20b3d0 帮助页面控制
- 538555f8 关于页面推荐应用点击问题
- c2f7542a 隐藏首页消息按钮
- 1ffba6af 笔记编辑页面的聊天页控制
- a5bfacf7 聊天入口隐藏
- cec34ccc 笔记-更多对话框显示控制
- ffe78ec2 应用主题和编辑器主题的控制
- af39d3e6 字体自定义页面的会员控制
- 3104b0cd 字体自定义页面的会员控制
- 86ae2bfd CSS自定义页面的会员控制
- a258a5ac 笔记浏览页面抽屉里信息的显示控制
- bc13c588 网页转笔记的会员控制
- a0f22f47 首页输入框更多按钮中加密的选项增加显示控制
- 0489bdeb 控制设置列表中的会员条目的展示
- 8885d369 首页抽屉增加会员显示控制
- bc4e9aba 判断是否显示VIP的逻辑调整，增加应用宝的配置
- f2acae69 判断是否显示VIP的逻辑调整，增加应用宝的配置
- 5e587358 移除基于 AndroidID 获取设备唯一 ID 的逻辑
- 4c927ee7 移除上传信息中的 mac 地址
- a5b03ed8 Merge pull request #199 from Shouheng88/feature-v5.2.3
## 5.2.3 
 - 5acc9aeb 文案
...
- 8dec7e2e fix: webdav server configuration issue
- de561199 fix: create note from intent
- 372bafa5 fix: npe
- 49fff538 fix: note creation from external
- 671088da fix: npe
- 88c2d7a1 Merge pull request #185 from Shouheng88/feature-v5.0.0
